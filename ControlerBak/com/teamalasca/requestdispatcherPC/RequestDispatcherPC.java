...
implements RequestSubmissionHandlerI, RequestNotificationHandlerI, AddVMRequestHandlerI, PushModeControllerI {
	 ...
	 */
	protected List<String> listOfVm;
	...
	protected Map<String, Long> currentRequest;
	...
	public RequestDispatcherPC(String AppUri) 
			throws Exception {
		super(1, 1);
		this.listOfVm = new ArrayList<String>();
		cts = 0;
		/**
	...
	public DataDistributeDynamic getDynamicData() throws Exception
	{
		cts++;
		DataDistributeDynamic d = new DataDistributeDynamic(uri, uri, sum / nbRequest);
		if (cts % 10 == 0)
		{
			cts = 0;
			sum = 0;
			...
			throws Exception
	{
		...
		long tmp = System.currentTimeMillis() - currentRequest.remove(r.getRequestURI());
	...
	public void	sendDynamicState() throws Exception
	{
		if (this.dcibp.connected()) {
			DataDistributeDynamicI DataDistribute = this.getDynamicData();
